...
namespace APIIntegratedBot
{
    ...
    class Program
    {
        ...
        private void Eventlogger(string Timestamp, string UserId, string reason)
        {
            Console.WriteLine("{0}, User \"{1}\" {2}", Timestamp, UserId, reason);
            TempEventLog[TempEventLog.Length] = (Timestamp + "User \"" + UserId + "\" " + reason);
        }
